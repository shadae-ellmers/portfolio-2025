...
export default function Contact() {
  return (
    ...
    >
      <h2 className="text-4xl font-semibold pb-5">The essentials:</h2>
      <div className="pb-5 flex flex-row justify-center gap-3 lg:gap-6 mx-auto">
        <a
          ...
          className="fill-brandCream flex flex-col justify-center my-auto cursor-pointer p-3 rounded-full bg-brandBlack hover:bg-brandCream hover:fill-brandBlack focus:bg-brandCream focus:fill-brandBlack"
        >
          <LinkedInIcon />
        </a>
        <a
